...
urlpatterns = [
    ...
    path('chat/private/rename/<chatroom_name>', private_room_rename, name='private-room-rename'),
    path('chat/private/waiting/<chatroom_name>/', code_room_waiting_list, name='code-room-waiting-list'),
    path('chat/private/waiting/<chatroom_name>/admit/', code_room_waiting_admit, name='code-room-waiting-admit'),
    path('chat/private/waiting/<chatroom_name>/status/', code_room_waiting_status, name='code-room-waiting-status'),
    ...
    path('chat/admin/global-banner/', admin_global_announcement_update_view, name='admin-global-banner'),
