    ...
    class Meta:
        ...
        widgets = {
            'body': forms.Textarea(attrs={
                ...
                'class': 'w-full bg-white/5 text-white border border-white/10 rounded-full px-4 pr-12 py-3 h-12 leading-6 outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500/30 placeholder:text-gray-400 text-sm sm:text-base placeholder:text-sm sm:placeholder:text-base resize-none overflow-hidden',
                'maxlength': '300',
                'rows': '1',
                'autofocus': True,
            }),
